    ...
    private void initComponents() {
        ...
        //======== dialogPane ========
        {
            ...
            //======== contentPanel ========
            {
                ...
                //---- button22 ----
                button22.setText("DEL");
                button22.setFont(button22.getFont().deriveFont(button22.getFont().getSize() + 10f));
                contentPanel.add(button22, new GridBagConstraints(4, 7, 1, 1, 0.0, 0.0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(0, 0, 0, 5), 0, 0));
